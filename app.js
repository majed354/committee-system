...
const MEMBERS = [
  ...
  'رجاء محمد هوساوي', 'عبدالله عيدان الزهراني (إداري)', 'منال منصور القرشي', 'خلود شاكر العبدلي',
  'عبدالعزيز عيضه الحارثي', 'آمنة جمعة قحاف', 'غدير محمد الشريف', 'أسرار عايف الخالدي (إداري)',
  'سلوى أحمد الحارثي', 'تغريد أبو بكر الخطيب', 'مها عيفان الخالدي', 'سلمى معيوض الجميعي',
  'أسماء محمد السلومي', 'رائد محمد الغامدي (إداري)', 'ماجد ابراهيم الجهني', 'عبدالعزيز عواض الثبيتي (إداري)', 'مرام طلعت ينكصار',
  'سعود سعد الأنصاري', 'عبدالرحمن العبيسي', 'ولاء حسن المذكوري', 'إسراء عبدالغني سندي',
  'وسام حسن المذكوري', 'سمر علي الشهراني', 'فاطمة أبكر أبكر', 'عفاف أحمد الشهيب','شيماء محمود بركات',
  'عبدالله سعد الثبيتي', 'عايده مصلح المالكي (مبتعث)'
];
